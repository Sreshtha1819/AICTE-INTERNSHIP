...
def main():
    ...
    if choice == "Home":
        ...
        if user_input:
            ...
            st.text_area("Chatbot:", response, height=120, max_chars=None, key="chatbot")                              
    ...
    # Conversation History Menu
        ...
        * Entities: The entities extracted from user input (e.g. "Hi", "How do I create a budget?,"What is your purpose?"
        ...
        st.write("In this project, a chatbot is built that can understand and respond to user input based on intents. The chatbot was trained using NLP and Logistic Regression, and interface was built using Streamlit. This project can be extended by adding more data, using more sophisticated NLP techniques, deep learning algorithms")
